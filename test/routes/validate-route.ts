...
// 2️⃣ QUERY ONLY
validateRequestRouter.get('/query', validateRequest({ query: querySchema }), (req, res) => {
...
// 3️⃣ PARAMS ONLY
validateRequestRouter.get('/params/:id', validateRequest({ params: paramsSchema }), (req, res) => {
